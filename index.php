...
<div class="authorization-visible">
    <form action="authorization.php" method="POST" class="authorization">
    <div class="row">
        <div class="authorization-title col-lg-12">Войти</div>
        <input type="text" class="col-lg-12" placeholder="Эл. адресс" name="adress">
        <input type="password" class="col-lg-12" placeholder="Эл. адресс" name="password">
        </div>
    ...
    <div class="header">
        <div class="container">
            ...
            <div class="col-lg-3 logo">
                ...
                <button class="col-lg-2 header-categories header-button">Вход на сайт</button>
            </div>
        </div>
    </div>
    <main>
